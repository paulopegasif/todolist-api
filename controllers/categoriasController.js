const { getCategoriasDB, addCategoriaDB,
  updateCategoriaDB, deleteCategoriaDB, getCategoriaPorCodigoDB } = require('../useCases/categoriaUseCases');
...
module.exports = { getCategorias, addCategoria, updateCategoria
